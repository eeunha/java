...
//		String regex = "[홍김최남궁]?길동";
	...
	private static void m3() {
		...
		// 정규 표현식 객체
		String txt = "안녕하세요. 홍길동입니다. 제 연락처는 010-1234-5678입니다. 제 메일은 hong@gmail.com입니다. 추가 연락처는 011-9876-5432입니다. 010-1212-3434";
...
//		System.out.println(m1.find()); // 검색 결과 -> 읽을 때 마다 횟수 사용됨.
...
//		System.out.printf("전화번호가 총 %d회 발견되었습니다.\n",count);
		...
		while (m1.find()) {
			...
			System.out.println("전화번호: " + m1.group(0)); // 0 -> 전체
			System.out.println("통신사: " + m1.group(1)); // -> 첫번째 소괄호
			System.out.println("앞자리: " + m1.group(2)); // -> 두번째 소괄호
			System.out.println("뒷자리: " + m1.group(3)); // -> 세번째 소괄호
